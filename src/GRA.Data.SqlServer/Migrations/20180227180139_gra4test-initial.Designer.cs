...
namespace GRA.Data.SqlServer.Migrations
{
    ...
    [Migration("20180227180139_gra4test-initial")]
    partial class gra4testinitial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarBundle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("DynamicAvatarBundles");
                });

            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarBundleItem", b =>
                {
                    b.Property<int>("DynamicAvatarBundleId");

                    b.Property<int>("DynamicAvatarItemId");

                    b.HasKey("DynamicAvatarBundleId", "DynamicAvatarItemId");

                    b.HasIndex("DynamicAvatarItemId");

                    b.ToTable("DynamicAvatarBundleItems");
                });

            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("DynamicAvatarLayerId");

                    b.Property<int>("SortOrder");

                    b.HasKey("Id");

                    b.HasIndex("DynamicAvatarLayerId");

                    b.ToTable("DynamicAvatarColors");
                });

            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarElement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("DynamicAvatarColorId");
                    ...
                    b.HasIndex("DynamicAvatarColorId");

                    b.HasIndex("DynamicAvatarItemId");

                    b.ToTable("DynamicAvatarElements");
                });

            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("DynamicAvatarItems");
                });

            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarLayer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GRA.Data.Model.UserAvatarItem", b =>
                {
                    ...
                    b.HasKey("UserId", "DynamicAvatarItemId");
            ...
            modelBuilder.Entity("GRA.Data.Model.UserDynamicAvatar", b =>
                {
                    b.Property<int>("UserId");

                    b.Property<int>("DynamicAvatarElementId");

                    b.HasKey("UserId", "DynamicAvatarElementId");

                    b.HasIndex("DynamicAvatarElementId");

                    b.ToTable("UserDynamicAvatars");
                });
            ...
            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarBundleItem", b =>
                {
                    b.HasOne("GRA.Data.Model.DynamicAvatarBundle", "DynamicAvatarBundle")
                        .WithMany("DynamicAvatarBundleItems")
                        .HasForeignKey("DynamicAvatarBundleId");

                    b.HasOne("GRA.Data.Model.DynamicAvatarItem", "DynamicAvatarItem")
                        .WithMany()
                        .HasForeignKey("DynamicAvatarItemId");
                });

            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarColor", b =>
                {
                    b.HasOne("GRA.Data.Model.DynamicAvatarLayer", "DynamicAvatarLayer")
                        .WithMany("DynamicAvatarColors")
                        .HasForeignKey("DynamicAvatarLayerId");
                });

            modelBuilder.Entity("GRA.Data.Model.DynamicAvatarElement", b =>
                {
                    b.HasOne("GRA.Data.Model.DynamicAvatarColor", "DynamicAvatarColor")
                        .WithMany()
                        .HasForeignKey("DynamicAvatarColorId");
            ...
            modelBuilder.Entity("GRA.Data.Model.Trigger", b =>
                {
                    b.HasOne("GRA.Data.Model.DynamicAvatarBundle", "AwardAvatarBundle")
                        .WithMany()
            ...
            modelBuilder.Entity("GRA.Data.Model.UserDynamicAvatar", b =>
                {
                    b.HasOne("GRA.Data.Model.DynamicAvatarElement", "DynamicAvatarElement")
                        .WithMany()
                        .HasForeignKey("DynamicAvatarElementId");
