...
{
    public partial class gra4testinitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicAvatarBundles", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "DynamicAvatarLayers",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicAvatarLayers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectPreregistrationEmails = table.Column<bool>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<int>(nullable: false),
                    ...
                    FacebookImageUrl = table.Column<string>(maxLength: 100, nullable: true),
                    ...
                    SiteLogoUrl = table.Column<string>(maxLength: 100, nullable: true),
                    TwitterCardImageUrl = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<int>(nullable: false),
                    Format = table.Column<string>(maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<int>(nullable: false),
                    DynamicAvatarLayerId = table.Column<int>(nullable: false),
                    SortOrder = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicAvatarColors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DynamicAvatarColors_DynamicAvatarLayers_DynamicAvatarLayerId",
                        column: x => x.DynamicAvatarLayerId,
                        principalTable: "DynamicAvatarLayers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "DynamicAvatarItems",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicAvatarItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DynamicAvatarItems_DynamicAvatarLayers_DynamicAvatarLayerId",
                        column: x => x.DynamicAvatarLayerId,
                        principalTable: "DynamicAvatarLayers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "DynamicAvatarBundleItems",
                columns: table => new
                {
                    DynamicAvatarBundleId = table.Column<int>(nullable: false),
                    DynamicAvatarItemId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicAvatarBundleItems", x => new { x.DynamicAvatarBundleId, x.DynamicAvatarItemId });
                    table.ForeignKey(
                        name: "FK_DynamicAvatarBundleItems_DynamicAvatarBundles_DynamicAvatarBundleId",
                        column: x => x.DynamicAvatarBundleId,
                        principalTable: "DynamicAvatarBundles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DynamicAvatarBundleItems_DynamicAvatarItems_DynamicAvatarItemId",
                        column: x => x.DynamicAvatarItemId,
                        principalTable: "DynamicAvatarItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "DynamicAvatarElements",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<int>(nullable: false),
                    DynamicAvatarColorId = table.Column<int>(nullable: true),
                    DynamicAvatarItemId = table.Column<int>(nullable: false),
                    Filename = table.Column<string>(maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicAvatarElements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DynamicAvatarElements_DynamicAvatarColors_DynamicAvatarColorId",
                        column: x => x.DynamicAvatarColorId,
                        principalTable: "DynamicAvatarColors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DynamicAvatarElements_DynamicAvatarItems_DynamicAvatarItemId",
                        column: x => x.DynamicAvatarItemId,
                        principalTable: "DynamicAvatarItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Triggers_DynamicAvatarBundles_AwardAvatarBundleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAvatarItems", x => new { x.UserId, x.DynamicAvatarItemId });
                    table.ForeignKey(
                        name: "FK_UserAvatarItems_DynamicAvatarItems_DynamicAvatarItemId",
                        column: x => x.DynamicAvatarItemId,
                        principalTable: "DynamicAvatarItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "UserDynamicAvatars",
                columns: table => new
                {
                    UserId = table.Column<int>(nullable: false),
                    DynamicAvatarElementId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDynamicAvatars", x => new { x.UserId, x.DynamicAvatarElementId });
                    table.ForeignKey(
                        name: "FK_UserDynamicAvatars_DynamicAvatarElements_DynamicAvatarElementId",
                        column: x => x.DynamicAvatarElementId,
                        principalTable: "DynamicAvatarElements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserDynamicAvatars_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DynamicAvatarBundleItems_DynamicAvatarItemId",
                table: "DynamicAvatarBundleItems",
                column: "DynamicAvatarItemId");

            migrationBuilder.CreateIndex(
                name: "IX_DynamicAvatarColors_DynamicAvatarLayerId",
                table: "DynamicAvatarColors",
                column: "DynamicAvatarLayerId");

            migrationBuilder.CreateIndex(
                name: "IX_DynamicAvatarElements_DynamicAvatarColorId",
                table: "DynamicAvatarElements",
                column: "DynamicAvatarColorId");

            migrationBuilder.CreateIndex(
                name: "IX_DynamicAvatarElements_DynamicAvatarItemId",
                table: "DynamicAvatarElements",
                column: "DynamicAvatarItemId");

            migrationBuilder.CreateIndex(
                name: "IX_DynamicAvatarItems_DynamicAvatarLayerId",
                table: "DynamicAvatarItems",
                column: "DynamicAvatarLayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAvatarItems_DynamicAvatarItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDynamicAvatars_DynamicAvatarElementId",
                table: "UserDynamicAvatars",
                column: "DynamicAvatarElementId");
